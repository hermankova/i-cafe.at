...
var getImageDate = function(ts) {
    var posted = new Date(ts * 1000); // timestamp to date
...
var renderBubble = function(data) {
    ...
    el.innerText = getImageCaption(item.caption.text);
...
var feed = new Instafeed({
    get: 'user',
    userId: '5905189497',
    accessToken: '5905189497.1677ed0.4d01227c50044720bb91069b9ae8e839',
    limit: 12,
